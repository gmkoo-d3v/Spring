...
<body>
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="mb-0">
                    <i class="bi bi-briefcase"></i> 직책별 직원 목록
                </h2>
                <p class="text-muted mb-0">${job} 직책의 직원 목록입니다.</p>
            </div>
            <div>
                <span class="badge bg-info" style="font-size: 1.5rem; padding: 0.75rem 1.5rem;">
                    ${job}
                </span>
            </div>
        </div>
        ...
        <div class="mb-3">
            <div class="btn-group" role="group">
                <a href="${pageContext.request.contextPath}/emp/empByJob.do?job=CLERK" 
                   class="btn ${job == 'CLERK' ? 'btn-info' : 'btn-outline-info'}">
                    CLERK
                </a>
                <a href="${pageContext.request.contextPath}/emp/empByJob.do?job=SALESMAN" 
                   class="btn ${job == 'SALESMAN' ? 'btn-info' : 'btn-outline-info'}">
                    SALESMAN
                </a>
                <a href="${pageContext.request.contextPath}/emp/empByJob.do?job=ANALYST" 
                   class="btn ${job == 'ANALYST' ? 'btn-info' : 'btn-outline-info'}">
                    ANALYST
                </a>
                <a href="${pageContext.request.contextPath}/emp/empByJob.do?job=MANAGER" 
                   class="btn ${job == 'MANAGER' ? 'btn-info' : 'btn-outline-info'}">
                    MANAGER
                </a>
                <a href="${pageContext.request.contextPath}/emp/empByJob.do?job=PRESIDENT" 
                   class="btn ${job == 'PRESIDENT' ? 'btn-info' : 'btn-outline-info'}">
                    PRESIDENT
                </a>
            </div>
        </div>
                                ...
                                <c:when test="${empty list}">
                                    <tr>
                                        <td colspan="8" class="text-center py-5">
                                            ...
                                            <p class="text-muted mt-3">해당 직책의 직원이 없습니다.</p>
                                        </td>
                                    </tr>
                                </c:when>
                                <c:otherwise>
                                    <c:forEach var="emp" items="${list}">
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-secondary">DEPT ${emp.deptno}</span>
                                            </td>
                                            <td>
        ...
        <c:if test="${not empty list}">
            <div class="row mt-4">
                ...
                <div class="col-md-4">
                    <div class="card bg-light">
                        <div class="card-body text-center">
                            <h5 class="card-title">총 급여</h5>
                            <p class="display-4 text-primary">
                                $<fmt:formatNumber value="${totalSal}" pattern="#,##0"/>
                            </p>
                        </div>
                    </div>
                </div>
