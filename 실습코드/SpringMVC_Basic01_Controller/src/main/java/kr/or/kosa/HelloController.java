...
public class HelloController implements Controller { //spring web 전용 자바파일 : Controller 구현
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		mav.addObject("name", "kosauser"); //request.setAttribute("name", "kosauser") 2차서 했던 코드가 이렇게됨
		mav.setViewName("Hello"); //뷰 지정  ///WEB-INF/views/Hello.jsp 2차서 했던 코드가 이렇게 된거
		
		//internalResourceViewResolver  <- view를 구성하는 객체 spring-servlet.xml 23 line
