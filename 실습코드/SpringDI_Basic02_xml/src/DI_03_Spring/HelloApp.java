...
public class HelloApp {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// 여기까지 컨테이너 만들어지고 그 안에 들어가있는 객체가 messageBean이 들어가 있을것이다. DI_03.xml을 통해서
		
		//interface 사용(다형성) .... 좋은 코드
		MessageBean messageBean = context.getBean("messageBean",MessageBean.class);
		messageBean.sayHello("hong");
		// MessageBean 부모타입으로 받자
		// 영어로 나오니 DI_03.xml에서 <bean id="messageBean" class="DI_03_Spring.MessageBean_en"></bean> 수정하면됨
